 ...
 * Example 1:
 * 
 * 	java PolygonEditor large-bird.gif -scale 0.2
 * 
 * lets you draw around the large-bird.gif image, generating polygon vertex coordinates on the
 ...
 * Example 2:
 * 
 * 	java PolygonEditor small-bird.gif 3.5f,19.5f, 14.5f,4.5f, 14.5f,-3.5f, 7.5f,-17.5f, -7.5f,-17.5f, -14.5f,-1.5f, -14.5f,4.5f, -3.5f,19.5f
 * 
 * lets you edit the polygon drawn in a previous session around the image small-bird.gif (not scaled).
 */
